        ...
        <div class="modal-content">
			...
			<form method="POST" action="edit_appoinment.php">
				...
				<div class="row form-group">
					<div class="col-sm-2">
						<label class="control-label modal-label">My Contact:</label>
					</div>
					<div class="col-sm-10">
				...
				<div class="row form-group">
					<div class="col-sm-2">
						<label class="control-label modal-label">My Email:</label>
					</div>
					<div class="col-sm-10">
                ...
                <div class="row form-group">
					<div class="col-sm-2">
						<label class="control-label modal-label">Appoinment Date:</label>
					</div>
					<div class="col-sm-10">
                  ...
                  <div class="row form-group">
					<div class="col-sm-2">
						<label class="control-label modal-label">Appoinment Time:</label>
					</div>
					<div class="col-sm-10">
